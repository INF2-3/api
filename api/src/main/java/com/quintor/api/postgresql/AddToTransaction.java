...
public class AddToTransaction {
     ...
     */
    public static Transaction makeTransaction(int id, LocalDate valueDate, String entryDate, String debCred, double amount, String transactionCode, String referenceOwner, String institutionReference, String supplementaryDetails, Description originalDescription, String description, int fileId, Category category) {
