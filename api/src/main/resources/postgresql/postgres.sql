...
CREATE SEQUENCE transaction_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 START 3 CACHE 1;
...
(0,	'2023-02-10',	'0210',	'c',	15615.21,	'N',	'EREF',	'00000000003071',	NULL,	1,	NULL,	1,	NULL);
